...
```{image} notebooks/01/media/topics.png
:alt: topics
:width: 500px
:align: center
```
...
To reinforce learning and encourage active engagement, each chapter concludes with exercises. These are designed to test your understanding and help you apply the lessons in practical contexts, ensuring that the knowledge gained is both deep and retainable.
...
You can read all the content of this book online. However, to get your hands-on experience with coding you should run the code snippets or the whole notebooks that you can find on Github
...
<iframe src="https://ghbtns.com/github-btn.html?user=FilippoMB&repo=python-time-series-handbook"&type=star&count=true&size=large" frameborder="0" scrolling="0" width="170" height="30" title="GitHub"></iframe>